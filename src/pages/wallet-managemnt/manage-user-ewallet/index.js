...
const ManageUserWallet = () => {
  ...
  const updateWallet = () => {
    if(!action){
      ...
      setOpen(true)
      axios
      .post(`${process.env.NEXT_PUBLIC_API_URL}/controlpanel/wallet/user/manage`,{
        user_id : userId,
  ...
  const columns = [
   ...
   
    {
      ...
      render: (_, object, index) => (
        <>
          <Link href='javascript:void(0)' onClick={e => manageHandler(object.user_id)}>Manage</Link>
        </>
      )
    },
    {
      ...
      render: (_, object, index) => (
        <>
          <Link href='javascript:void(0)' onClick={() => viewDetails(object.user_id)}>View</Link>
        </>
      )
    },
  ...
  return (
    ...
    <Grid item xs={12}>
        <Box >
          <Typography variant='h5' sx={{my:8}}>Wallet Management  </Typography>
                  ...
                  <Grid container spacing={3}>
                    <Card component='div' sx={{ position: 'relative', mb: 7 }}>
                      <CardContent>
                        <Grid container spacing={3}>
                          <Grid item xs={12}>
                            <TextField xs={6} fullWidth label='User Id' value={userId} placeholder='User Id' disabled={true} />
                          </Grid>
                          <Grid item xs={12}>
                            <TextField xs={6} fullWidth  onChange={e => setAmount(e.target.value)} value={amount} label='Amount' placeholder='Amount' type='number' />
                          </Grid>
                          <Grid item xs={12}>
                            <TextField xs={6} fullWidth onChange={e => setRemark(e.target.value)} value={remark} label='Remarks' placeholder='Remarks' />
                          </Grid>
                          <Grid item xs={12}>
                            <Box sx={{ minWidth: 120 }}>
                              <FormControl fullWidth>
                                ...
                                <Select
                                  ...
                                  value={action}
                                >
                                  {['add', 'subtract'].map(c=><MenuItem value={c}>{c}</MenuItem>)}
                                </Select>
                              </FormControl>
                            </Box>
                          </Grid>
                          <Grid item xs={12}>
                            <TextField xs={6} fullWidth label='Wallet Type' placeholder='Wallet Type' disabled={true} value={'Income Wallet'} />
                          </Grid>
                        </Grid>
                      </CardContent>
                    </Card>
