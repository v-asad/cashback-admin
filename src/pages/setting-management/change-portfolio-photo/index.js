...
const ChangeProfilePhoto = () => {
  ...
  const uploadProfilePicture = () => {
    if(!uploadLogo){
      ...
      axios.post(`${process.env.NEXT_PUBLIC_API_URL}/controlpanel/settings/profile-picture`, formData, {
        headers: {
  ...
  return (
    <>
      ...
      <ImageList sx={{ width: 500, height: data.image?200:40 }} cols={3} rowHeight={164}>
        ...
        ):(uploadLogo?  <ImageList sx={{ width: 500, height: 200 }} cols={3} rowHeight={164}>
